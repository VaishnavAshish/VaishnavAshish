...
--
-- Host: localhost
-- Generation Time: Jul 18, 2017 at 09:17 PM
...
CREATE TABLE IF NOT EXISTS `topics` (
  ...
  `topic` varchar(255) NOT NULL,
  `cat_id` int(11) NOT NULL,
  `type` int(11) NOT NULL COMMENT '0-folder,1-questions,2-basics,3-videos',
  `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `topics` (`topic_id`, `topic`, `cat_id`, `type`, `created`) VALUES
(11, 'Questions And Answer', 23, 0, '0000-00-00 00:00:00'),
(12, 'Basics', 24, 2, '2017-07-18 19:14:35'),
(13, 'Questions & Answers', 24, 0, '0000-00-00 00:00:00'),
(14, 'Computer Science', 28, 0, '2017-07-18 19:04:10');
...
INSERT INTO `users` (`uid`, `name`, `email`, `password`, `fbid`, `date_created`, `status`) VALUES
(1, 'Admin', 'admin@padhlepappu.com', '$2vJMIHXMBFH2', '', '2017-07-14 09:55:04', 0),
(7, 'Antriksh Chhipa', 'antrikshchhipa@gmail.com', '', '1086747071455694', '2017-07-18 16:11:54', 1),
(10, 'Antriksh chhipa', 'antrikshchhipa@yahoo.com', '$2/UbwcMXYvRg', '', '2017-07-15 05:06:38', 1);
