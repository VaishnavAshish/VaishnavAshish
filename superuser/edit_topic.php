				...
				<!--Add category form-->
					<form class="form-horizontal" action="" method="post">
							<div class="form-group">
							  ...
							  <div class="col-sm-10">
								<input type="text" class="form-control"  placeholder="Enter Topic name" name="topic" value="<?php echo $row['topic'];?>">
							  </div>
							</div>
					...
					<div class="content-top" align="center">
							...
							<table class="table table-bordered" style="width: 75%; text-align:center;">
									...
									<?php 
										$i=0;
										$result = mysql_query("Select * from topics join category on topics.cat_id = category.cat_id");
										while($row=mysql_fetch_array($result))
										{
											$i+=1;
