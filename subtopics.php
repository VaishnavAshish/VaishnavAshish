...
{	$cat_id = htmlspecialchars($_GET['cat_id'],ENT_QUOTES);
	$catQuery="SELECT * FROM `category` where cat_id=".$cat_id." LIMIT 1";
	$category_query=mysql_query($catQuery);
	$category=mysql_fetch_array($category_query);
	$query=mysql_query("SELECT * FROM `topics` where topics.cat_id='".$cat_id."' ");
}
